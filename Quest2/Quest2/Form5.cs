    ...
    public partial class Form5 : Form
    {
        ...
        private void Form5_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (finish)
            {
                ...
                gamer.notes.Add("Дело сделано. Вы открываете деревянный ящик.");
                gamer.notes.Add("Вы ничего не понимаете и ничего не видите.");
                gamer.notes.Add("Из него выливается яркий свет, ослепляющий вас.");
                gamer.notes.Add("Наконец вы просыпайтесь после комы в больнице!");
                gamer.notes.Add("Это был лишь сон, вам удалось проснуться!"");
